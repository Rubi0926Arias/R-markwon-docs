...
Como $t=`r summary(reg)[["coefficients"]][2,3]`$ es `r tex<-"menor"; if(summary(reg)[["coefficients"]][2,3]>qt(0.975,(nrow(data)-2))) tex<-"mayor"; tex`que $t_{`r (nrow(data)-2)`}(\frac{\alpha}{2})= `r qt(0.975,(nrow(data)-2))`$
`r tex<-"no rechazo"; if(summary(reg)[["coefficients"]][2,3]>qt(0.975,(nrow(data)-2))) tex<-"rechazo"; tex` 
$H_0: \beta_2=0$.

### Intervalos de confianza
El intervalo de confianza para $\beta_2$, es $$`r s=confint(reg,level = 0.95);s[2,1]`\leq \beta_2 \leq `r s[2,2]` $$
